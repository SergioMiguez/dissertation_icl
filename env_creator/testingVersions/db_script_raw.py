...
def main():
    ...
    for i, distro in enumerate(linux_dict):
        ...
        cmd = f"./testingVersions/lxc_with_start.sh {distro} {ct_id + i} {distro_template[distro]} {gateway} {sdn_ip}{sdn_end + i} {ips}"
        print(cmd)
...
if __name__ == "__main__":    
    ...
    try:
        with open("attack_state.json", "r") as f:
            attack_state = json.loads(f)
    except Exception as e:
        print("Error reading attack_state")
        sys.exit(1)
